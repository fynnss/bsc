...
func (b *nodebuffer) flush(db ethdb.KeyValueStore, clean *fastcache.Cache, id uint64, force bool) error {
	...
	log.Debug("Persisted pathdb nodes", "nodes", len(b.nodes), "origin_bytes", common.StorageSize(b.size), "batch_bytes", common.StorageSize(size), "elapsed", common.PrettyDuration(time.Since(start)))
	b.reset()
	return nil
}
